...
def one_at_a_time (dof,arm_name,simulation_db,joint_types,links):
    ...
    import os.path
    if(os.path.isfile('/home/ar1/catkin_ws/src/sock-puppet/results/testtttttttt.csv')):
        pd.DataFrame(simulation_db).to_csv('/home/ar1/catkin_ws/src/sock-puppet/results/testtttttttt.csv', mode='a', index= True, header=False)
    else:
        pd.DataFrame(simulation_db).to_csv('/home/ar1/catkin_ws/src/sock-puppet/results/testtttttttt.csv', index= True)
...
if __name__ == '__main__':
    ...
    # os.rename(directory + arm_name_urdf+'.xacro', '/home/ar1/catkin_ws/src/sock-puppet/man_gazebo/urdf/6dof_tested_arms/' + arm_name_urdf+'.xacro')
    ...
    '''
    sim = Simulator(arm_name, dof=6,folder = 'arms_test',create=False)
    sim.create_urdf_from_csv(csv_name="testt", folder="arms_test", num_of_group=1, min_length=1.4)
